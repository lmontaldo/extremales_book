...
```{r nice-fig2, echo=FALSE, fig.cap='Niveles máximos anuales del nivel del mar en Port Pirie (1923-1987)', ,echo=FALSE, fig.height=3, fig.width=6, message=FALSE, warning=FALSE}

plot(portpirie,  xlab = "Year", ylab = "Sea Level (meters)", col="red")
```
...
Medias Móviles^[Moving Averages en inglés.] de orden $q$ [@enders]. El proceso $MA(q)$ con $m=q$ puede expresarse como
