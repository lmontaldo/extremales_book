...
df_long <- pivot_longer(df, cols = -x, names_to = "Distribución", values_to = "CDF")

# Gráfico
ggplot(df_long, aes(x = x, y = CDF, color = Distribución)) +
  geom_line(size = 1.2) +
...
```{r frcolas, fig.cap="Distribución Fréchet para dististos parámetros de forma" ,echo=FALSE, fig.height=3, fig.width=3, message=FALSE, warning=FALSE}
...
llamamos $F^{\ast}_n$ a la distribución de $max(X_1,\dots,X_n)$ y $n$
