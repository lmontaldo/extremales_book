...
- si $\xi = 0$ entonces se tiene una recta;

- si $\xi <0$, la curva es convexa con límite asintótico a medida que  $p \to 0$ en $\mu - \beta / \xi$; 

- si $\xi <0$, la curva es cóncava y no tiene un límite finito.
