...
Lo anterior implica que se puede aproximar a la Eq.\@ref(eq:Mnr) como una integrante de la familia de GEV cuando $n$ es grande. Este argumento conlleva al siguiente enfoque para modelar las observaciones de datos extremos $X_1,X_2,\dots$. Se forman bloques de observaciones de largo $n$ (para $n$ grande) lo que permite crear bloques de máximos $M_{n,1},\dots, M_{n,m}$. Con esto va a ser posible ajustar una distibución GEV [@coles2001introduction].
